...
export const CurrencyDollarIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.21 12.75 11 12 11c-.75 0-1.536.21-2.121.621m-1.732 4.062a4.5 4.5 0 01-2.141-2.141m-2.141-2.141a4.5 4.5 0 012.141-2.141M12 6a4.5 4.5 0 00-2.121-.621 4.5 4.5 0 00-1.732 4.062M12 18a4.5 4.5 0 012.121.621 4.5 4.5 0 011.732-4.062M12 6a4.5 4.5 0 012.121.621 4.5 4.5 0 011.732 4.062" />
    </svg>
);
